<%@ Page Language="VB" AutoEventWireup="true" CodeFile="vb_WeddingFill.aspx.vb" Inherits="HTMLEditor_vb_WeddingFill" %>
               ...
               >
                  <Columns>
                    <asp:TemplateColumn headertext="Select" > 
                          <ItemTemplate> 
                             <input type="radio" name="grpSelect" tabindex="9" value='<%# (CType(Container.DataItem,DataRowView))("id") %>'
                              <%# GetChecked(CBool((CType(Container.DataItem,DataRowView))("checked"))) %> /> 
                          </ItemTemplate> 
                    </asp:TemplateColumn> 
                    ...
                    <asp:TemplateColumn headertext="Date" > 
                          <ItemTemplate> 
                             <%# (CDate((CType(Container.DataItem, DataRowView))("fldDate"))).ToShortDateString()%>
                          </ItemTemplate> 
                    </asp:TemplateColumn> 
            ...
            <ContentTemplate>
               <div style="height: 300px; width:650px" id="container">
                   <asp:Label runat="server" ID="Preview" >
                       ...
                       <img alt="" id="wait1" align="absMiddle" style="visibility:hidden; height: 30px" src="<%=Page.ClientScript.GetWebResourceUrl(GetType(Obout.Ajax.UI.HTMLEditor.Editor), "Obout.Ajax.UI.HTMLEditor.Images.ed_wait.gif")%>" />
                       <br />
                   ...
                   <asp:Label runat="server" ID="Edit" Visible="false" >
                       ...
                       <img alt="" id="wait2" align="absMiddle" style="visibility:hidden; height: 30px" src="<%=Page.ClientScript.GetWebResourceUrl(GetType(Obout.Ajax.UI.HTMLEditor.Editor), "Obout.Ajax.UI.HTMLEditor.Images.ed_wait.gif")%>" />
                       <obout:Editor runat="server" Id="editor" Height="100%" Width="100%" EditPanel-OnClientLoaded="editorLoaded">
