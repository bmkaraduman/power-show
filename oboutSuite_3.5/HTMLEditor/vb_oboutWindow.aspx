<%@ Page Language="VB" AutoEventWireup="true" CodeFile="vb_oboutWindow.aspx.vb" Inherits="HTMLEditor_vb_oboutWindow" %>
<%@ Register
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
               ...
               <obout:Window runat="server" ShowMaximizeButton="true" Title="Edit" Overflow="HIDDEN" ID="myWindow"
                   ...
                   <img id="wait" align="absMiddle" style="visibility:hidden; height:30px;" src="<%=Page.ClientScript.GetWebResourceUrl(GetType(Obout.Ajax.UI.HTMLEditor.Editor), "Obout.Ajax.UI.HTMLEditor.Images.ed_wait.gif")%>" />
               </obout:Window>
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
