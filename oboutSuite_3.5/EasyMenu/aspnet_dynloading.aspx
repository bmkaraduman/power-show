...
<script language="C#" runat="server">
	void Page_Load(object sender, EventArgs e) 
	{
			...
			Html = "Dynamic Load";
			oTree.Add("root", "a3", Html, true, "Folder.gif\" onclick=\"ob_t25(document.getElementById('a3'))", "aspnet_dyntreeview.aspx");
			attachTo += "a3";
...
<html>
    ...
    <body>
	    <form id="Form1" runat="server">
		    ...
		    <span class="tdText"><b>ASP.NET Easy Menu - Dynamic Loading</b></span>
