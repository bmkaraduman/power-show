...
<head runat="server">
    <title>obout ASP.NET Captcha examples</title>
    <style type="text/css">
                td.link{
                        padding-left:30px;
                        width:250px;                    
...
<body style="margin-left:30px;">
    ...
    <div class="tdText">
        ...
        <br /><br /><br />
        <span style="font-weight:bold;">Obout.Ajax.UI.Captcha examples</span>
        <br />
        <br />
                   ...
                   <table style="margin-top:0px;padding-top:0px;">
                       <tr>
                          <td valign="top" style="margin-top:0px;padding-top:0px;">
                              <table style="margin-top:0px;padding-top:0px;">
                                 <tr>
                                     <td class="link"><a href=""><nobr>First look</nobr></a></td>
                                     <td class="fname">cs_FirstLook.aspx</td>
                                 </tr>

                                 <tr>
                                     <td class="link"><a href="">With ValidationSummary control</a></td>
                                     <td class="fname">cs_ValidationSummary.aspx</td>
                                 </tr>

                                 <tr>
                                     <td class="link"><a href="">In UserControl</a></td>
                                     <td class="fname">cs_UserControl.aspx</td>
                                 </tr>

                                 <tr>
                                     <td class="link"><a href="">In UserControl with increase feature</a></td>
                                     <td class="fname">cs_UserControlWithIncrease.aspx</td>
                                 </tr>

                                 <tr>
                                     <td class="link"><a href="">With <b>FileUpload</b> control and client-side validation</a></td>
                                     <td class="fname">cs_FileUploadAndClientSideValidation.aspx</td>
                                 </tr>
                              </table>
                          </td>
                       </tr>
