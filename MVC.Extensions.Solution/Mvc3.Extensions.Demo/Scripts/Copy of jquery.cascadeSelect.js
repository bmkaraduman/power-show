(function ($) {
    ...
    var toggleNoInfoText = function (element, visible) {
        ...
        //If toggle is called then all child should be hidden
    ...
    var methods = {
        ...
        clear: function () {
            ...
            if (onClearCallback && $.isFunction(onClearCallback)) {
                ...
                //TODO: MAke sure you check for chooseText presence
                if (options.noInfoText) {
            ...
            if (onLoadCallback && $.isFunction(onLoadCallback)) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        var domElement = element.get(0); // because $('#id') != document.getElementById('id')
