...
public static class MVC {
    static readonly CascadingDropDownListsClass s_CascadingDropDownLists = new CascadingDropDownListsClass();
    public static CascadingDropDownListsClass CascadingDropDownLists { get { return s_CascadingDropDownLists; } }
    static readonly LabelClass s_Label = new LabelClass();
    public static LabelClass Label { get { return s_Label; } }
    static readonly SelectClass s_Select = new SelectClass();
    public static SelectClass Select { get { return s_Select; } }
    static readonly VariousClass s_Various = new VariousClass();
    public static VariousClass Various { get { return s_Various; } }
    public static Mvc3.Extensions.Demo.Controllers.HomeController Home = new Mvc3.Extensions.Demo.Controllers.T4MVC_HomeController();
    public static T4MVC.SharedController Shared = new T4MVC.SharedController();
}

namespace T4MVC {
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class CascadingDropDownListsClass {
        public readonly string Name = "CascadingDropDownLists";
        public Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.DropDownAjaxPostController DropDownAjaxPost = new Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.T4MVC_DropDownAjaxPostController();
        public Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.DropDownHijaxPostController DropDownHijaxPost = new Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.T4MVC_DropDownHijaxPostController();
        public Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.DropDownjQueryAjaxPostController DropDownjQueryAjaxPost = new Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.T4MVC_DropDownjQueryAjaxPostController();
        public Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.DropDownNormalPostController DropDownNormalPost = new Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.T4MVC_DropDownNormalPostController();
        public Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.DropDownNormalPostPRGController DropDownNormalPostPRG = new Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.T4MVC_DropDownNormalPostPRGController();
        public Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.HomeController Home = new Mvc3.Extensions.Demo.Areas.CascadingDropDownLists.Controllers.T4MVC_HomeController();
        public T4MVC.CascadingDropDownLists.SharedController Shared = new T4MVC.CascadingDropDownLists.SharedController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class LabelClass {
        public readonly string Name = "Label";
        public Mvc3.Extensions.Demo.Areas.Label.Controllers.PersonController Person = new Mvc3.Extensions.Demo.Areas.Label.Controllers.T4MVC_PersonController();
        public T4MVC.Label.SharedController Shared = new T4MVC.Label.SharedController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class SelectClass {
        public readonly string Name = "Select";
        public Mvc3.Extensions.Demo.Areas.Select.Controllers.CitiesController Cities = new Mvc3.Extensions.Demo.Areas.Select.Controllers.T4MVC_CitiesController();
        public T4MVC.Select.SharedController Shared = new T4MVC.Select.SharedController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class VariousClass {
        public readonly string Name = "Various";
        public Mvc3.Extensions.Demo.Areas.Various.Controllers.ToolTipsController ToolTips = new Mvc3.Extensions.Demo.Areas.Various.Controllers.T4MVC_ToolTipsController();
        public Mvc3.Extensions.Demo.Areas.Various.Controllers.TreeViewController TreeView = new Mvc3.Extensions.Demo.Areas.Various.Controllers.T4MVC_TreeViewController();
        public T4MVC.Various.SharedController Shared = new T4MVC.Various.SharedController();
    }
}
...
namespace Links {
    ...
    public static class Scripts {
        ...
        public static readonly string Copy_of_jquery_cascadeSelect_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Copy of jquery.cascadeSelect.min.js") ? Url("Copy of jquery.cascadeSelect.min.js") : Url("Copy of jquery.cascadeSelect.js");
                      
        public static readonly string jquery_1_6_1_vsdoc_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery-1.6.1-vsdoc.min.js") ? Url("jquery-1.6.1-vsdoc.min.js") : Url("jquery-1.6.1-vsdoc.js");
                      
        public static readonly string jquery_1_6_1_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery-1.6.1.min.js") ? Url("jquery-1.6.1.min.js") : Url("jquery-1.6.1.js");
        ...
        public static readonly string jquery_cascadeSelect_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.cascadeSelect.min.js") ? Url("jquery.cascadeSelect.min.js") : Url("jquery.cascadeSelect.js");
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class jquery_treeview {
            private const string URLPATH = "~/Scripts/jquery.treeview";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class images {
                private const string URLPATH = "~/Scripts/jquery.treeview/images";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            ...
            public static readonly string jquery_treeview_async_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.treeview.async.min.js") ? Url("jquery.treeview.async.min.js") : Url("jquery.treeview.async.js");
            ...
            public static readonly string jquery_treeview_sortable_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.treeview.sortable.min.js") ? Url("jquery.treeview.sortable.min.js") : Url("jquery.treeview.sortable.js");
